...
function func_minusmonth() {
	var f = document.myform;
	f.addmonth.value = -1;
	f.submit();
}

function func_minusyear() {
	var f = document.myform;
	f.addyear.value = -1;
	f.submit();
}
...
<caption>
<span onclick="func_minusyear()" style="cursor:pointer">◁</span><span onclick="func_minusmonth()" style="cursor:pointer">◀</span>
...
<% } %>
</select>월<span onclick="func_addmonth()" style="cursor:pointer">▶</span><span onclick="func_addyear()" style="cursor:pointer">▷</span></caption>
<tr>
